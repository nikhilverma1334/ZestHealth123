...
export default function LoginPage() {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Tokens are now set via httpOnly Set-Cookie headers natively by the backend
      
      // Determine redirection based on JWT payload or simple reload
      window.location.href = '/reception'; // Will route properly in a real app based on role parsing
    } catch (err: any) {
      setError(err.message);
    } finally {
      setLoading(false);
